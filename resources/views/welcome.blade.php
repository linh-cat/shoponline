					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> 123@hotmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
                        ...
                        <a href="/"><img src="{{('/front_end/images/home/logo.png')}}" alt="pro" /></a>
						</div>
					</div>
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
                                <?php
                                    ...
                                    if ($customer_id !=Null) {
                                        echo '<li><a href="/checkout"><i class="fa fa-lock"></i> Checkout</a></li>';
                                    }else if($customer_id !=Null && $Shipping_id !=Null){
                                        echo '<li><a href="/payment"><i class="fa fa-lock"></i> Checkout</a></li>';
                                    }else{
                                        echo '<li><a href="/login-checkout"><i class="fa fa-lock"></i> Checkout</a></li>';
                                    }
                                ?>
                                ...
                                <?php
                                    $customer_id = Session::get('customer_id');
                                    if ($customer_id !=Null) {
                                        echo '<li><a href="/logout-checkout"><i class="fa fa-lock"></i> Logout</a></li>';
                                    }else{
                                        echo '<li><a href="/login-checkout"><i class="fa fa-lock"></i> Login</a></li>';
                                    }
                                ?>
							</ul>
						</div>
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
                            <form action="/search" method="post">
                                ...
                                <button class="btn btn-primary" style="margin-top: -1px">search</button>
                            </form>
						</div>
					</div>
				</div>
						...
						<div class="panel-group category-products" id="accordian">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
                                    <h4 class="panel-title"><a href="/category-product/{{$cate->category_id}}">{{$cate->category_name}}</a></h4>
								</div>
							</div>
                            @endforeach
                        </div>
						...
						<div class="brands_products">
                            ...
                            <div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="/brand-product/{{$brands->brand_id}}"> <span class="pull-right">(50)</span>{{$brands->brand_name}}</a></li>
								</ul>
							</div>
                            @endforeach
                        </div>
